...
export function createBoxDemo(container: HTMLElement) {
    ...
    const TailwindDemo = () => (
        <Box className="w-150 h-100 bg-blue rounded-lg p-4 shadow-lg" position={[220, 50]} />
    )
    ...
    const NestedBoxesDemo = () => (
        <Box
            ...
            position={[460, 180]}
        >
            <Box className="bg-red" width={60} height={60} borderRadius={6} position={[0, 0]} />
            <Box
            ...
            <Box
                ...
                position={[160, 0]}
            />
            <Box className="bg-blue" width={180} height={60} borderRadius={6} position={[40, 80]} />
        </Box>
    )
    ...
    const ArbitraryValuesDemo = () => (
        <Box className="w-[180px] h-[80px] bg-[#ff1744] rounded-[16px]" position={[220, 330]} />
    )
