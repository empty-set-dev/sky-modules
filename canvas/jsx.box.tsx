...
import { mergeTailwindClasses, tailwindClassesToCSS } from './jsx.box-twrn'
...
export function Box(props: BoxProps): any {
    ...
    const width = typeof mergedStyles.width === 'number'
        ? mergedStyles.width
        : parseFloat(String(mergedStyles.width || 100))

    const height = typeof mergedStyles.height === 'number'
        ? mergedStyles.height
