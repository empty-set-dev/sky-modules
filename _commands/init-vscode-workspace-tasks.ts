...
export namespace init {
    vscodeWorkspaceTasks()

    export async function vscodeWorkspaceTasks(): Promise<void> {
        ...
        const vsCodeWorkspaceConfig = JSON.parse(
            fs.readFileSync(vsCodeWorkspaceConfigPath, 'utf-8')
        )
