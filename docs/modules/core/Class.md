...
<!--- This Class was auto-generated using "pnpm exec sky readme" --> 
...
```typescript
import { Class } from '@sky-modules/core'
```

## [Standard](..%2F..%2Fcore%2FREADME.md): Class [(Source)](..%2F..%2Fcore%2FClass%2F)
