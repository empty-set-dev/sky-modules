...
<!--- This idle was auto-generated using "pnpm exec sky readme" --> 
...
```typescript
import { idle } from '@sky-modules/core'
```

## [Standard](..%2F..%2Fcore%2FREADME.md): idle [(Source)](..%2F..%2Fcore%2Fidle%2F)
