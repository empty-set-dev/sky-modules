...
class SkyAssetsManager {
    ...
    getTextureOptions(name: string): SkyAssetsManager.TextureOptions {
        return this.__textures[name]
    }

    async loadTexture(
        name: string,
        options: SkyAssetsManager.LoadTextureOptions = {}
    ...
    private __textures: Record<string, SkyAssetsManager.TextureOptions> = {}
    private __loaders: Record<string, number> = {}
}

export default SkyAssetsManager
